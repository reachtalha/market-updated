...
const Step = ({
  ...
  return (
    <div className="flex flex-1 items-center flex-col">
      <div
        className={`bg-[#414D354D]  transition-all duration-500  w-[3rem] h-[3rem] rounded-full flex items-center justify-center font-bold ${
...
const Stepper = ({ step, data }: StepperProps) => {
  return (
