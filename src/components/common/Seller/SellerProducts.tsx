'use client';
import { Product, columns } from '@/app/[lang]/seller/products/columns';
import { DataTable } from '@/app/[lang]/seller/products/data-table';
...
export default function SellerProducts({ dictionary }: { dictionary: any }) {
