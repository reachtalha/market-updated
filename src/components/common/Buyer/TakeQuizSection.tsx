...
export default function TakeQuizSection({ className = '', buttonClassName = '' } : TakeQuizSection){
  return (
    <div className={twMerge(`bg-primary text-white text-center py-28 px-10`, className)}>
      ...
      <Button variant="outline" size="lg" className={twMerge(`mt-6 border-white uppercase w-fit bg-transparent rounded-3xl`, buttonClassName)}>Take our quiz</Button>
    </div>
  )
}