  ...
  return (
    <section className={` py-10`}>
      ...
      <div>
        ...
        <div>
          <div className="flex flex-row gap-x-3">
            <div className="space-y-1 w-full mt-3">
              <Label className=" font-medium text-sm sm:text-base  text-gray-600">Name</Label>
              <Input
            ...
            <div className="space-y-1 w-full mt-3">
              <Label className="text-sm sm:text-base font-medium  text-gray-600">Card Type</Label>
        ...
        <div className="space-y-1 w-full mt-3">
          <Label className="text-sm sm:text-base font-medium  text-gray-600">Card Number</Label>
          <Input
            className="w-full rounded-xl border-[2px] border-gray-300 p-2.5 transition-transform delay-75 duration-300 placeholder:text-sm hover:border-killarney-700 focus:-translate-y-[2px]  focus:border-0 py-[1.4rem]"
            type="text"
            disabled={!isEdit}
        ...
        <div className="flex flex-row gap-x-3">
          <div className="space-y-1 w-full mt-3">
            <Label className="text-sm sm:text-base font-medium  text-gray-600">CVC</Label>
            <Input
              className="w-full rounded-xl border-[2px] border-gray-300 p-2.5 transition-transform delay-75 duration-300 placeholder:text-sm hover:border-killarney-700 focus:-translate-y-[2px]  focus:border-0 py-[1.4rem]"
              type="text"
              placeholder="123"
          ...
          <div className="space-y-1 w-full mt-3">
            <Label className="text-sm sm:text-base font-medium  text-gray-600">Expiry Date</Label>
            <Input
              className="w-full rounded-xl border-[2px] border-gray-300 p-2.5 transition-transform delay-75 duration-300 placeholder:text-sm hover:border-killarney-700 focus:-translate-y-[2px]  focus:border-0 py-[1.4rem]"
              type="text"
              disabled={!isEdit}
